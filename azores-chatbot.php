...
(function() {
    ...
    function restoreSessionState() {
        try {
            ...
            if (data && data.html) {
                ...
                // Re-bind click events on restored chips if any
                ...
                if (data.isOpen) {
                    openChat(true); // Restore as open without greeting delay
                }
                return true;
            }
        } catch (e) {}
    ...
    function openChat(isRestoring = false) {
        ...
        // First-open welcome message if no session state existed
        if (!isRestoring && msgCount === 0) {
            setTimeout(() => {
                ...
                setTimeout(() => {
                    hideTyping();
                    addBotMsg(
                        "Hello! 👋 Welcome to <strong>Azores Infrastructure</strong>. I'm <strong>Nick</strong> — how can I assist you with your construction or infrastructure requirements today?",
